    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">
          {userRole === "claimant" && "Track your lost items and view potential matches."}
          {userRole === "finder" && "Manage your found item reports and help reunite items."}
          {userRole === "manager" && "Oversee the lost and found system operations."}
        </p>
      </div>
