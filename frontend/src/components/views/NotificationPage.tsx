...
export const NotificationPage = ({ userRole }: NotificationPageProps) => {
  ...
  const getAllNotifications = (): Notification[] => {
    ...
    if (userRole === "manager") {
      baseNotifications.push({
        id: 5,
        type: "POTENTIAL_OWNER_FOUND",
        title: "Match pending approval - Please review and confirm",
        message: "A potential owner has been found for the found iPhone 13 Pro. Please review the match details and approve or deny.",
